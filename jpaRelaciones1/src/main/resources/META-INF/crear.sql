CREATE TABLE `Libros` (`isbn` VARCHAR(255) NOT NULL,`titulo` VARCHAR(255) NOT NULL,`autor` VARCHAR(255) NOT NULL,`fecha` DATE NOT NULL,`precio` INT NOT NULL,`categorias_nombre` VARCHAR(255),PRIMARY KEY (`isbn`));
